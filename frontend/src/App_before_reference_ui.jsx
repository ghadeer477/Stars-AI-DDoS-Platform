    ...
    return (
      <div style={{
        ...
        <div style={{...glass, padding: '50px', width: '420px', textAlign: 'center'}}>
          ...
          <h2 style={{ margin: '0 0 8px 0', fontSize: '28px', fontWeight: '800' }}>Stars</h2>
      ...
      <div style={{
       ...
       ...glass,
        ...
        <div style={{
          ...
          {sidebarOpen && (
            <div>
              <h1 style={{ margin: 0, fontSize: '20px', fontWeight: '800', background: 'linear-gradient(90deg, #38bdf8, #c084fc)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Stars</h1>
